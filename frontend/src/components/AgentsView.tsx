...
export function AgentsView({
  ...
  return (
    <div className="flex-1 flex flex-col min-h-0">
      {/* Composer */}
      <div className="border-b border-zinc-800 px-3 py-3 sm:px-6 sm:py-4 bg-zinc-950">
        <div className="max-w-3xl mx-auto space-y-3">
          <div className="flex items-center gap-2 text-zinc-300">
            <Bot size={18} className="text-blue-400" />
            <h2 className="text-sm font-semibold">Agents</h2>
            <span className="hidden sm:inline text-xs text-zinc-600">Give a goal — type <span className="font-mono text-zinc-500">/</span> for commands.</span>
            {selectedAgent && (
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <button
              ...
              className={clsx('ml-auto flex items-center gap-1.5 rounded-lg px-4 py-2 text-sm font-medium transition-colors',
            ...
            <div className="mt-5 border-t border-zinc-800 pt-4">
              ...
              <div className="flex flex-col items-stretch gap-2 sm:flex-row sm:items-end">
                ...
                <button
                  ...
                  className={clsx('flex items-center justify-center gap-1.5 rounded-lg px-4 py-2.5 text-sm font-medium transition-colors',
